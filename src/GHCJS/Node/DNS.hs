...
foreign import javascript interruptible
  ...
  unsafeLookup :: HostName
               -> Family
               -> Hints
               -> IO (Nullable Error, Address, Family)
...
foreign import javascript interruptible
  ...
  unsafeLookupAll :: HostName
                  -> Family
                  -> Hints
                  -> IO (Nullable Error, Array Resolved)
